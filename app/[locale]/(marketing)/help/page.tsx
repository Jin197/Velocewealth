...
const GUIDE_DETAILS: Record<string, GuideDetail> = {
  add_vehicle: {
...
export default function HelpPage() {
  ...
  const activeGuide = activeGuideKey ? GUIDE_DETAILS[activeGuideKey] : null;

  return (
    <div className="px-4 sm:px-6 lg:px-8 py-12 max-w-4xl mx-auto w-full space-y-12 bg-background relative min-h-screen">
      <div>
      ...
      <section className="space-y-4">
        <h2 className="font-display text-lg font-semibold text-white">Guides rapides interactifs</h2>
      ...
      {/* FAQ */}
      <section className="space-y-4">
        <h2 className="font-display text-lg font-semibold text-white">Questions fréquentes</h2>
      ...
      {/* Contact */}
      <section className="space-y-4">
        <h2 className="font-display text-lg font-semibold text-white">Besoin d&apos;aide personnalisée ?</h2>
        <Card className="p-6 bg-gradient-to-r from-[#007AFF]/10 to-transparent border border-white/5 backdrop-blur-md rounded-card">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4 min-w-0">
              ...
              <div className="min-w-0">
                <div className="text-sm font-semibold text-white">Assistance VeloceWealth</div>
