    ...
    Tables: {
      ...
      maintenance_tasks: {
        Row: {
          ...
          last_reminder_phase: string | null;
          last_reminder_sent_at: string | null;
          status: 'pending' | 'scheduled' | 'in_progress' | 'done' | 'snoozed' | 'dismissed';
      ...
      in_app_notifications: {
        Row: {
          id: string;
          user_id: string;
          kind: 'maintenance_reminder' | 'maintenance_overdue' | 'fine_majoration_soon' | 'fine_added' | 'mfa_required' | 'other';
          title: string;
          body: string | null;
          link: string | null;
